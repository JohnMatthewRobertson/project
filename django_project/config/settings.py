...
SITE_ID = 1
 ...
 # email address user for sign in
ACCOUNT_AUTHENTICATION_METHOD = 'email'

# email required field for registration
ACCOUNT_EMAIL_REQUIRED = True

# enforce registration requires unique email
...
'''
    EMAIL SETTING USED FOR CONFIRMATION EMAIL
    AND PASSWORD RESETS
'''
